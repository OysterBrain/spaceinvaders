...
public class SpaceInvaders implements Jeu {
	...
	public void positionnerEnvahisseur(Dimension dimension, Position position, int vitesse) {
		int x = position.abscisse();
		int y = position.ordonnee();
	...
	public void faireDeplacerEnvahisseurAGauche() {
	...
	public void faireDeplacerEnvahisseurADroite() {
	...
	private void deplacerEnvahisseur() {
		if (this.aUnEnvahisseur() && envahisseur.doitSeDeplacerVersLaDroite()) {
			faireDeplacerEnvahisseurADroite();				
		}
		
		if (this.aUnEnvahisseur() && !envahisseur.doitSeDeplacerVersLaDroite()) {
			faireDeplacerEnvahisseurAGauche();
		}
